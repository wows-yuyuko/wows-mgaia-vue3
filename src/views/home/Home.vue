...
const wgOa = () => {
  ...
  window.open('https://api.worldoftanks.' + (player.server === 'na' ? 'com' : player.server) + '/wot/auth/login/?application_id=907d9c6bfc0d896a2c156e57194a97cf&redirect_uri=https://api.wows.shinoaki.com/public/wows/oauth/wows/yuyuko/success')
}
