...
import { getPlayerListByUserName, searcBanCn } from '@/api/wowsV3/wowsPlayer'
...
const searchUserList = (query: string) => {
  getPlayerListByUserName({ server: 'cn', userName: query, limit: 5 }).then(
    response => {
